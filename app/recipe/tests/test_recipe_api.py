...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'cabbage'},{'name':'ketchup'}]
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 20,
            'price': Decimal('5.00'),
            'ingredients': [{'name': 'Lettuce'}, {'name': 'Mayonnaise'}],
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        """Test filtering recipices by tags"""
        r1 = create_recipe(user=self.user, title="Banku and okra")
        r2 = create_recipe(user=self.user, title="Banku and Soup")
        tag1 = Tags.objects.create(user=self.user, name='Vegan')
        tag2 = Tags.objects.create(user=self.user, name='Vegetarian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)

        r3 = create_recipe(user=self.user, title='KFC')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Chicken Wings")
        ...
        r3 = create_recipe(user=self.user, title="Some food")
